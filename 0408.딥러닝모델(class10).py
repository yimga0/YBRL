...
train_data = pd.read_csv(r"C:/Users/abbey/Desktop/동작분류(10class)/train_data_10class.csv")
test_data = pd.read_csv(r"C:/Users/abbey/Desktop/동작분류(10class)/test_data_10class.csv")
...
model_checkpoint = keras.callbacks.ModelCheckpoint(filepath=r'C:/Users/abbey/Desktop/동작분류(10class)/epoch2/{epoch}-{loss:.5f}.keras',
                                                   monitor='loss',
                                                   save_best_only=True,
                                                   verbose=1)
'---------------------------------------------------------------------------------------------------------------------'
...
train_target_split = train_targe_onehot[:split_index]
val_target_split = train_targe_onehot[split_index:]

# fit 함수에 분할한 데이터 전달
hist = teacher.fit(x_train_split, train_target_split,  epochs=epochs, batch_size=32, validation_data=(x_val_split, val_target_split),
...
'------------------------------------------------------결과-----------------------------------------------------------'
teacher = tf.keras.models.load_model(r'C:/Users/abbey/Desktop/동작분류(10class)/epoch2/23-0.06709.keras')
