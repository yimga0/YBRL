...
#파일경로
path = r'C:\Users\lsoor\OneDrive\바탕 화면\임가영\삼성개발데이터\삼성 개발 데이터셋\samsung_csv\\'
path_graph = r'C:\Users\lsoor\OneDrive\바탕 화면\임가영\삼성개발데이터\gragh\graph_samsung\\'
